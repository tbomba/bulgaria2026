...
const baseSections = [
  {
    ...
    icon: "🗺️",
    title: "Trasa",
    desc: "Z Prahy do Primorska -- celá trasa",
    glow: "59, 130, 246",
  },
  {
    path: "/places",
  ...
  },
  {
    ...
    icon: "🏆",
    title: "Výzvy",
    desc: "Nejhorší tým hraje mokrej piškot",
    glow: "245, 158, 11",
  },
  {
    path: "/photos",
  ...
  },
  {
    ...
    icon: "💡",
    title: "Návrhy",
    desc: "Hlasuj o aktivitách a nápadech",
    glow: "34, 197, 94",
  },
];
...
<template>
  <div class="page-container">
    ...
    <div class="text-center mb-8 sm:mb-12">
      <h1
        class="text-3xl sm:text-5xl lg:text-7xl font-heading font-extrabold text-white mb-3 sm:mb-4 animate-float tracking-tight"
      >
        🇧🇬 Bulharsko 2026
      </h1>
      <p
        class="text-neutral-400 text-base sm:text-lg lg:text-xl mb-1 sm:mb-2 max-w-lg mx-auto"
      >
        Z Prahy do Primorska
      </p>
    ...
    <div class="card p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 max-w-2xl mx-auto">
      <h2
        class="text-center font-heading font-bold text-sm sm:text-lg text-neutral-400 mb-3 sm:mb-5 uppercase tracking-wider"
      >
        Odpočet do odjezdu
      </h2>
      <CountdownTimer />
    ...
    <div class="grid grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
      ...
      >
        ...
        <p
          class="text-xl sm:text-2xl lg:text-3xl font-heading font-extrabold text-white mt-0.5 sm:mt-1"
        >
          {{ stat.value }}
        </p>
        <p
          class="text-[9px] sm:text-[11px] lg:text-xs text-neutral-500 font-medium uppercase tracking-wider"
        >
          {{ stat.label }}
        </p>
      </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
      ...
      >
        ...
        <div>
          <div
            class="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center text-lg sm:text-xl lg:text-2xl bg-white/[0.06] border border-white/[0.1] shadow-lg shadow-black/20 mb-2 sm:mb-3 group-hover:border-[rgba(var(--glow),0.3)] transition-colors duration-500"
          >
            <span class="group-hover:animate-wiggle">{{ section.icon }}</span>
          </div>
          <h3
            class="font-heading font-bold text-base sm:text-lg lg:text-xl text-white"
          >
            {{ section.title }}
          </h3>
        </div>
        <p class="text-neutral-500 text-xs sm:text-sm mt-1 line-clamp-2">
          {{ section.desc }}
        </p>

        <!-- Arrow indicator -->
        <div
          class="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 opacity-0 group-hover:opacity-60 transition-all duration-300 translate-x-1 group-hover:translate-x-0"
        >
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
            :style="`color: rgba(${section.glow}, 0.8)`"
          >
            <path
